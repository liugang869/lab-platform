...
if __name__ == '__main__':
    os.system('cp '+fpath+'/reference/runaimdb_n.cc '+fpath+'/../AIMDB/system/runaimdb.cc')
    os.chdir (fpath+'/../AIMDB/')
    os.system('make')
    os.chdir (fpath+'/../Lab3_Test2/')
    os.system(fpath+'/../AIMDB/runaimdb '+fpath+'/data/tpch_schema_r.txt '+fpath+'/data/sf100Mt/')
